...
public class ClientJdbcDao implements ClientDao {
    ...
    private static final String SQL_LIST_CLIENTS = "SELECT * FROM client ORDER BY company_name, phone_number, client_id";
    ...
    private static final String SQL_UPDATE_CLIENT = "UPDATE client SET (company_name, phone_number, website, street_address, city, state, zip_code)"
                                                  + " = (:companyName, :phoneNumber, :website, :streetAddress, :city, :state, :zipCode)"
                                                  + " WHERE client_id = :clientId";
    private static final String SQL_CREATE_CLIENT = "INSERT INTO client (company_name, phone_number, website, street_address, city, state, zip_code)"
                                                  + " VALUES (:companyName, :phoneNumber, :website, :streetAddress, :city, :state, :zipCode)";
